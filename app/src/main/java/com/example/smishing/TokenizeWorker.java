...
public class TokenizeWorker extends Worker {

    public TokenizeWorker(@NonNull Context context, @NonNull WorkerParameters workerParams) {
    ...
    public Result doWork() {
        ...
        String functionUrl = "https://us-central1-smishing-21d6a.cloudfunctions.net/tokenizeMessage";
        ...
        try {
            ...
            try (BufferedReader br = new BufferedReader(new InputStreamReader(httpURLConnection.getInputStream(), "utf-8"))) {
                ...
                Log.d("tokenized","토큰화 : " + Arrays.toString(tokens));
